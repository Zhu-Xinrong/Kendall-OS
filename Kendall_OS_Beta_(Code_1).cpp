...
int main(){
	...
	system("cls");
	*/
	system("title Kendall OS Beta (Code 1) - 主界面");
	while(1){
		...
		switch(Choose1){
			case 1:{
				system("title Kendall OS Beta (Code 1) - 倒计时");
				Clock1 c;
			...
			case 2:{	
				system("title Kendall OS Beta (Code 1) - 正计时");
				Clock2 c;
				c.run();
				system("pause");
				system("title Kendall OS Beta (Code 1) - 主界面");
			...
			case 3:{
				system("title Kendall OS Beta (Code 1) - 数学计算");
				int Choose2;
				...
				switch(Choose2){
					case 1:{
						system("title Kendall OS Beta (Code 1) - 最大公因数计算器");
						int n0,n1,p,max;
					...
					case 2:{
						system("title Kendall OS Beta (Code 1) - 最小公倍数计算器");
						int n0,n1,p,max;
						cout<<"输入(不得超过2147483647的两个整数 空格隔开)：";
						cin>>n0>>n1;
						if(n0<0||n1<0)cout<<"别逝了，我已经考虑到了。"<<endl;
					...
					case 3:{
						system("title Kendall OS Beta (Code 1) - 圆");
						cout<<"你要进行哪种计算？"<<endl;
			...
			case 4:{
				system("title Kendall OS Beta (Code 1) - 逢七必过");
				int a;
				cout<<"数字到几？";
				cin>>a;
				for(int i=1;i<a;){
			...
			case 5:{
				system("title Kendall OS Beta (Code 1) - 关于");
				system("cls");
				Sleep(1500);
				for(int i=0;i<24;i++){
					cout<<endl;
