	...
	while(1){
		...
		switch(Choose1){
			...
			case 3:{
				...
				switch(Choose2){
					case 1:{
						system("title Kendall OS - 最大公因数计算器");
						int n0,n1,p,max;
					...
					case 2:{
						system("title Kendall OS - 最小公倍数计算器");
						int n0,n1,p,max;
						cout<<"输入(不得超过2147483647的两个整数 空格隔开)：";
						cin>>n0>>n1;
						if(n0<0||n1<0)cout<<"别逝了，我已经考虑到了。"<<endl;
